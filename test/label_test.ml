...
let qualified_name_law_tests = [
  ( "Qualified Name Law Tests", [
      Alcotest.test_case "Test 1" `Quick (test_qualified_name_of_law law1 "L1") ;
      Alcotest.test_case "Test 2" `Quick (test_qualified_name_of_law law2 "L1")
    ]
  );
]
...
let qualified_name_of_level_tests = [
  ( "Qualified Name of Level Tests", [
      Alcotest.test_case "Test 1" `Quick (test_qualified_name_of_level article1 "(A1)") ;
      Alcotest.test_case "Test 2" `Quick (test_qualified_name_of_level article2 "(A1)(A2)") ;
      Alcotest.test_case "Test 3" `Quick (test_qualified_name_of_level article3 "(A1)(A2)(A3)") ;
    ]
  );
]
...
let qualified_name_tests = [
  ( "Qualified Name Tests", [
      Alcotest.test_case "Test 1" `Quick (test_qualified_name l1 "L1 ") ;
      Alcotest.test_case "Test 2" `Quick (test_qualified_name l2 "L1 ") ;
      Alcotest.test_case "Test 1" `Quick (test_qualified_name l3 "L1 A1") ;
      Alcotest.test_case "Test 2" `Quick (test_qualified_name l4 "L1 A1(A2)") ;
      Alcotest.test_case "Test 3" `Quick (test_qualified_name l5 "L1 A1(A2)(A3)") ;
      Alcotest.test_case "Test 4" `Quick (test_qualified_name l6 "L1 A1(A2)") ;
      Alcotest.test_case "Test 5" `Quick (test_qualified_name l7 "L1 A1(A2)(A3)")
    ]
  );
]
