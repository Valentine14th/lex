...
```
(.gdprfs-venv) user@host:~/GDPR-compliant_FS$ sudo PYTHONPATH=. python3 gdprfs/myfs.py /tmp/mnt -f -o allow_other
PEP mapping keys: [('MyFS', 'read'), ('MyFS', 'write')]
./enfguard/bin/enfguard.exe -sig ./gdprfs/policies/gdpr_draft.sig -formula ./gdprfs/policies/consent_draft.mfotl -json
