...
@InstrumentORM(
    logger,
    {"PageVisit.path", "PageVisit.method", "PageVisit.status_code", "PageVisit.referrer", 
     "PageVisit.user_agent", "PageVisit.session_key", "PageVisit.ip_hash", 
     "PageVisit.response_time_ms", "PageVisit.created_at"},
    info=info_page_visit, events={'read', 'write'}
)
