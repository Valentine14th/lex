...
class InstrumentationMapping:
    ...
    def __init__(self, mapper : Dict[str, Callable[[Event], Union[list[Event], Event, None]]], ignore_other : bool = False):
        self.mapper       = mapper
...
class PEP:
    ...
    def __init__(
        ...
        instrumentation_mapping : Union[InstrumentationMapping, None]               = None,
    ):
